...
\newline
%
\texttt{192.232.0.0\slash22} \hspace{10} $\rightarrow$ \hspace{10} less precise
%
\newline
\newline
%
\texttt{192.232.0.0\slash24} \hspace{10} $\rightarrow$ \hspace{10} more precise
%
\newline
\newline
%
...
\newline
%
\href{https://de.wikipedia.org/wiki/Border_Gateway_Protocol?useskin=vector}
{wikipedia.org/wiki/Border\_Gateway\_Protocol}
%
\newline
\newline
%
...
\newline
%
\href{https://de.wikipedia.org/wiki/Exterior-Gateway-Protokoll?useskin=vector}
...
\newline
%
\href{https://www.linkedin.com/pulse/understanding-bgp-its-advantages-over-egp-role-peter
-smulovics-kvrae}{linkedin.com/pulse/understanding-bgp}
%
\newline
\newline
%
...
\newline
%
\href{https://www.catchpoint.com/bgp-monitoring/bgp-hijacking}
...
\newline
%
\href{https://research.google/pubs/youtube-hijacking-february-24th-2008-analysis-of-bgp
-routing-dynamics/}
...
\newline
%
\href{https://www.ripe.net/about-us/news/youtube-hijacking-a-ripe-ncc-ris-case-study/}
...
\newline
%
\href{https://www.lancom-systems.de/docs/LCOS/Refmanual/DE/topics/bgp-rpki.html}
...
\newline
%
\href{https://en.wikipedia.org/wiki/BGPsec?useskin=vector}
...
\newline
%
\href{https://www.noction.com/knowledge-base/bgp-filtering}
