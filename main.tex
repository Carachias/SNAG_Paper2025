...
Sicherheitsmechanismen integriert, da diese der Geschwindigkeitsanforderung an das
Protokoll im Wege stehen würden.
%
Um BGP zu sichern sind daher zusätzliche Maßnahmen und Protokolle wie
SBGP~\citep{kent2002secure}, BGPSec~\citep{lepinski2017bgpsec} oder RPKI nötig.
%
\begin{figure}[!h]
%\centering
...
\begin{itemize}[leftmargin=*]
    ...
    \item Kapitel 1 (Introduction) in den Abstract mergen
    \item Kapitel 2 in Introduction umwandeln und Redundanzen entfernen
