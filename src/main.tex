...
%
Außerdem werden teils unterschiedliche Begriffe für die Gleichen Angriffe verwendet,
wie es zum Beispiel bei \enquote{Prefix Hijacking} und \enquote{Origin Hijacking} der
Fall ist.
%
...
%
In diesem Paper werden wir deshalb die relativ gängige Einteilung in
...
Identifikation von Incidents deutlich erleichtern soll.
%
...
\begin{itemize}
    ...
    \item Kapitel zwischen 1 und 2 Einfügen, das einen \enquote{durchschnittlichen
    Angreifer} beschreibt
